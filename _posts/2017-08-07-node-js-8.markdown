...
> NOTE_ [JSON Formatter](https://aaronleedev.github.io/developmenttool/2017/08/11/development-tool-json-formatter.html)  
...
app.dell('/user/:id', function (req, res) {
...
> NOTE_ [Tabbed Postman - REST Client](https://aaronleedev.github.io/developmenttool/2017/08/18/development-tool-postman.html)  
> 크롬에서 HTTP 요청을 수행하는 확장 프로그램